...
AUTHOR_MAP = {
    ...
    "260355617@qq.com": "loulanyue",  # 2026-09-24 approval-gate sync (/deny <reason>, cb6c47af08)
    ...
    "huangsen365@gmail.com": "huangsen365",  # 2026-07-02 security sync (aiohttp CVE floor across lazy messaging deps)
    ...
    "DavidMetcalfe@users.noreply.github.com": "DavidMetcalfe",  # same contributor, alternate noreply email variant (2026-06-26 upstream sync)
    "SJWATTS89@OUTLOOK.COM": "lEWFkRAD",  # 2026-06-26 upstream sync
    "daniel.laforce@argobox.com": "KeyArgo",  # 2026-06-26 upstream sync
    "poli.koltsova@gmail.com": "wnuuee1",  # 2026-06-26 upstream sync
