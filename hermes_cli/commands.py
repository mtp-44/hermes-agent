...
COMMAND_REGISTRY: list[CommandDef] = [
    ...
    CommandDef("wait", "Keep waiting for the current local-model response", "Session",
               gateway_only=True),
    ...
    CommandDef("local", "Switch this gateway session back to the local model route", "Configuration",
               gateway_only=True),
    CommandDef("claude", "Switch this gateway session to the Claude Sonnet route", "Configuration",
               gateway_only=True),
    CommandDef("opus", "Switch this gateway session to the Claude Opus route", "Configuration",
               gateway_only=True),
    CommandDef("5.5", "Switch this gateway session to GPT-5.5 route", "Configuration",
               gateway_only=True, aliases=("55", "gpt55")),
    ...
    CommandDef("fast", "Switch this gateway session to the fast model route", "Configuration",
               gateway_only=True),
