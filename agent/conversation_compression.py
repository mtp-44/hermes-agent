    ...
    try:
        ...
        if agent._session_db:
            try:
                ...
                # away regardless of whether the id rotates). Open Brain capture
                # needs the boundary_reason/parent lineage, so keep our kwargs on
                # the call (agent.session_id here is still the pre-compaction id).
