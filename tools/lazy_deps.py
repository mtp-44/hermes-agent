...
LAZY_DEPS: dict[str, tuple[str, ...]] = {
    ...
    "platform.discord": (
        ...
        "aiohttp==3.14.3",  # GHSA-9548-qrrj-x5pj; CVE-2026-34513/34518/34519/34520/34525 + 34993(RCE)/47265
    ),
    "platform.slack": (
        "slack-bolt==1.27.0",
        "slack-sdk==3.40.1",
    ...
    "platform.teams": ("microsoft-teams-apps==2.0.13.4", "aiohttp==3.14.3"),  # aiohttp 3.14.3: GHSA-9548-qrrj-x5pj; 3.14.1: CVE-2026-34993(RCE)/47265 + 34513/34518/34519/34520/34525
